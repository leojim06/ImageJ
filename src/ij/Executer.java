...
public class Executer implements Runnable {
     ...
     * thread using the specified image, or using the active image if 'imp' is
     * null.
     */
     ...
     * NonBlockingGenericDialog, the following plugins are allowed
     */
    boolean allowedWithLockedImage(String className) {
        return className.equals("ij.plugin.Zoom")
                ...
                || className.equals("ij.plugin.SimpleCommands")
                || //includes Plugins>Utiltites>Reset (needed to reset a locked image)
    ...
    /**
     * Opens a file from the File/Open Recent menu and returns 'true' if
     * successful.
     */

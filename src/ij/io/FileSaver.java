...
public class FileSaver {
     ...
     * false if the user selects cancel. Equivalent to IJ.saveAsTiff(imp,""),
    ...
    /**
     * Converts this image to a TIFF encoded array of bytes, which can be
     * decoded using Opener.deserialize().
     */

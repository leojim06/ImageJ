...
public class TiffEncoder {
    ...
    /**
     * Saves the image as a TIFF file. The OutputStream is not closed. The
     * fi.pixels field must contain the image data. If fi.nImages>1 then
     * fi.pixels must be a 2D array. The fi.offset field is ignored.
     */
    ...
    /**
     * Writes image metadata ("info" property, stack slice labels, channel
     * display ranges, luts, ROIs, overlays, properties and extra metadata).
     */

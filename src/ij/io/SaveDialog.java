...
public class SaveDialog {
    ...
    /**
     * Displays a file save dialog with 'title' as the title, 'defaultName' as
     * the initial file name, and 'extension' (e.g. ".tif") as the default
     * extension.
     */
    ...
    /**
     * Displays a file save dialog, using the specified default directory and

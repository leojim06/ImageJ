 ...
 * and System.err streams to ImageJ's log console. The purpose is to allow use
 * of existing Java classes or writing new generic Java classes that only output
 * to System.out and are thus less dependent on ImageJ. See the ImageJ plugin
 * Redirect_System_Streams at http://staff.fh-hagenberg.at/burger/imagej/ for
 * usage examples.
 *
 * @author Wilhelm Burger (wilbur at ieee.org) See Also: Redirect_System_Streams
...
public class LogStream extends PrintStream {
     ...
     * <code>System.err</code> to ImageJ's log console using the default
     * prefixes.
     */
     ...
     * Redirects all output sent to <code>System.out</code> and
     * <code>System.err</code> to ImageJ's log console using the default
     * prefixes. Alternatively use {@link #redirectSystemOut(String)} and
     * {@link #redirectSystemErr(String)} to redirect the streams separately and
     * to specify individual prefixes.
     */
    ...
    /**
     * Redirects all output sent to <code>System.out</code> to ImageJ's log
     * console.
     *
     * @param prefix The prefix string inserted at the start of each output
     * line. Pass <code>null</code> to use the default prefix or an empty string
    ...
    /**
     * Redirects all output sent to <code>System.err</code> to ImageJ's log
     * console.
     *
     * @param prefix The prefix string inserted at the start of each output
     * line. Pass <code>null</code> to use the default prefix or an empty string
    ...
    /**
     * Returns the redirection stream for {@code System.out} if it exists. Note
     * that a reference to the current output stream can also be obtained
     * directly from the {@code System.out} field.
     *
     * @return A reference to the {@code PrintStream} object currently
     * substituting {@code System.out} or {@code null} of if {@code System.out}
    ...
    /**
     * Returns the redirection stream for {@code System.err} if it exists. Note
     * that a reference to the current output stream can also be obtained
     * directly from the {@code System.err} field.
     *
     * @return A reference to the {@code PrintStream} object currently
     * substituting {@code System.err} or {@code null} of if {@code System.err}
     * is currently not redirected.
     */
     ...
     * <code>System.err</code> to their original output streams.
     */
    ...
    /**
     * Use this method to revert<code>System.out</code> to the original output
     * stream.
     */
    ...
    /**
     * Use this method to revert<code>System.err</code> to the original output
     * stream.
     */

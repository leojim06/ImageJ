 ...
 * <p>
 * Format of the original 64 byte ImageJ/NIH Image .roi file header. Two byte
 * numbers are big-endian signed shorts. The JavaScript example at
 * http://wsr.imagej.net/macros/js/DecodeRoiFile.js demonstrates how to use this
 * information to decode a .roi file.
 * <pre>
 * 0-3		"Iout"
 * 4-5		version (>=217)
 ...
 * <pre>
 * @see
 * <a href="http://wsr.imagej.net/macros/js/DecodeRoiFile.js">DecodeRoiFile.js</a>
 */

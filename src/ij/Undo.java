...
/**
 * This class consists of static methods and fields that implement ImageJ's Undo
 * command.
 */
public class Undo {
    ...
    /**
     * Undo using a single image, or composite color stack, copy (limited to
     * 200MB).
     */
    ...
    public static void undo() {
        ...
        if (IJ.debugMode) {
            IJ.log("Undo.undo: " + whatToUndo + " " + imp + "  " + impCopy);
        }

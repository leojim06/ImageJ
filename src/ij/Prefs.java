...
public class Prefs {
    ...
    /**
     * Assume DICOM volumes use identical RescaleSlope and RescaleIntercept
     * across all slices
     */
    ...
    /**
     * Enable this option to workaround a bug with some Linux window managers
     * that causes windows to wander down the screen.
     */
     ...
     * using the keyword <code>key</code>. The string can be retrieved using the
    ...
    /**
     * Finds and loads the configuration file ("IJ_Props.txt") and the
     * preferences file ("IJ_Prefs.txt").
     *
    ...
    /**
     * Retrieves a string from IJ_Props or IJ_Prefs.txt. Does not retrieve
     * strings set using Prefs.set().
     */
    ...
    /**
     * Retrieves a number from IJ_Props or IJ_Prefs.txt. Does not retrieve
     * numbers set using Prefs.set().
     */
    ...
    /**
     * Retrieves a boolean from IJ_Props or IJ_Prefs.txt. Does not retrieve
     * boolean set using Prefs.set().
     */

...
public class VirtualStack extends ImageStack {
     ...
     * @see #addSlice(String)
     * @see
     * <a href="http://wsr.imagej.net/macros/js/OpenAsVirtualStack.js">OpenAsVirtualStack.js</a>
     */
     ...
     * VirtualStack(w,h,cm,path) constructor. The argument can be a full file
     * path (e.g., "C:/Users/wayne/dir1/image.tif") if the 'path' argument in
     * the constructor is "". File names that start with '.' are ignored.
     */
     ...
     * {@literal 1<=n<=nslices}. Returns null if the stack is empty.
     */
    ...
    /**
     * Returns the file name of the specified slice, where
     * {@literal 1<=n<=nslices}.
     */
    ...
    /**
     * Returns the ImagePlus Properties assoctated with the current slice, or
     * null.
     */
    ...
    /**
     * Sets the table that translates slice numbers of hyperstacks not in
     * default CZT order.
     */

...
public class Toolbar extends Canvas implements MouseListener, MouseMotionListener, ItemListener, ActionListener {
    ...
    /**
     * Sets the foreground color to grayscale, where value is between 0 (black)
     * and 255 (white).
     */
    ...
    /**
     * Sets the background color to grayscale, where value is between 0 (black)
     * and 255 (white).
     */
    ...
    /**
     * Sets the tool menu long click delay in milliseconds (default is 600). Set

...
public class Line extends Roi {
    ...
    /**
     * Sets the x1d, y1d, x2d, y2d line end points, the (legacy) integer
     * coordinates of the end points x1, y1, x2, y2 the 'bounds' subpixel
     * rectangle of the Roi superclass (spanned by the end points), the int x,
     * y, width, height integer bounds of the superclass (these enclose the
     * 'draw' area for 1 pixel width), and the coordinates x1R, y1R, x2R, y2R
     * relative to the base x, y of the 'bounds'
     */
     ...
     * starting and ending coordinates as a 2-point Polygon, or, if the width is
     * greater than one, returns an outline of the line as a 4-point Polygon.
     *
     * @see #getFloatPolygon
     * @see #getPoints
     */
    ...
    /**
     * If the width of this line is less than or equal to one, returns the
     * starting and ending coordinates as a 2-point FloatPolygon, or, if the
     * width is greater than one, returns an outline of the line as a 4-point
     * FloatPolygon.
     *
     * @see #getFloatPoints
     */
     ...
     * {@code ImageProcessor.getLine(double, double, double, double)}.

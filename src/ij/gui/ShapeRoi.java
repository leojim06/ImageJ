...
public class ShapeRoi extends Roi {
     ...
     * flattened shape is the closest approximation of the original shape's
     * curve segments with line segments. The FLATNESS is an indication of the
     * maximum deviation between the flattened and the original shape.
     */
    static final double FLATNESS = 0.1;

    /**
     * Flatness used for filling the shape when creating a mask. Lower values
     * result in higher accuracy (determining which pixels near the border are
     * filled), but lower speed when filling shapes with curved borders.
     */
    static final double FILL_FLATNESS = 0.01;

    /**
     * Parsing a shape composed of linear segments less than this value will
     * result in Roi objects of type {@link ij.gui.Roi#POLYLINE} and
    ...
    /**
     * The instance value of the coefficient (FLATNESS) used to obtain a
     * flattened version of this ROI's shape.
     */
     ...
     * of line segments. If <strong><code>true</code></strong> then (sub)path
     * will be parsed into a {@link ij.gui.Roi#TRACED_ROI}; else, into a
     ...
     * composed of only two line segments will be of type
     * {@link ij.gui.Roi#ANGLE}. If <strong><code>true</code></strong> then
     * (sub)path will be parsed into a {@link ij.gui.Roi#ANGLE}; else, into a
     * {@link ij.gui.Roi#POLYLINE}.
     */
     ...
     * @param forceTrace flag for conversion of Shape objects to Roi objects
     ...
     * {@link ij.gui.Roi#POLYLINE} or {@link ij.gui.Roi#POLYGON}; conversion of
     * shapes with linear segments more than this value will result in Roi
     * objects of type {@link ij.gui.Roi#FREELINE} or {@link ij.gui.Roi#FREEROI}
     * unless the average side length is large (see {@link #shapeToRois()}).
     */
     ...
     * Each segment consists of the segment type followed by 0-6 coordintes (0-3
     * end points and control points). Depending on the type, a segment uses
     * from 1 to 7 elements of the array.
     */
     ...
     *
     * @return the union of <strong><code>this</code></strong> and
     * <code>sr</code>
     */
    ...
    /**
     * Unary intersection operator. The caller is set to its intersection with
     * the argument (i.e., the overlapping regions between the operands).
     *
     * @return the overlapping regions between
     ...
     *
     * @return <strong><code>this</code></strong> subtracted from
     * <code>sr</code>
     */
     ...
     */
    /**
     * Converts the Roi argument to an instance of java.awt.Shape. Currently,
     * the following conversions are supported:<br>
     * <table><col><col><col><col><col><col><col>
     * <thead>
     * <tr><th scope=col> Roi class </th><th scope=col> Roi type
     * </th><th scope=col> Shape </th><</tr>
     * </thead>
     * <tbody>
     * <tr><td> ij.gui.Roi </td>       <td> Roi.RECTANGLE </td><td>
     * java.awt.geom.Rectangle2D.Double </td></tr>
     * <tr><td> ij.gui.OvalRoi </td>   <td> Roi.OVAL </td>     <td> java.awt.Polygon
     * of the corresponding traced roi </td></tr>
     * <tr><td> ij.gui.Line </td>      <td> Roi.LINE </td>     <td>
     * java.awt.geom.Line2D.Double </td></tr>
     * <tr><td> ij.gui.PolygonRoi </td><td> Roi.POLYGON </td>  <td>
     * java.awt.Polygon or (if subpixel resolution) closed
     * java.awt.geom.GeneralPath </td></tr>
     * <tr><td> ij.gui.PolygonRoi </td><td> Roi.FREEROI </td>  <td>
     * java.awt.Polygon or (if subpixel resolution) closed
     * java.awt.geom.GeneralPath </td></tr>
     * <tr><td> ij.gui.PolygonRoi </td><td> Roi.TRACED_ROI</td><td>
     * java.awt.Polygon or (if subpixel resolution) closed
     * java.awt.geom.GeneralPath </td></tr>
     * <tr><td> ij.gui.PolygonRoi </td><td> Roi.POLYLINE </td> <td> open
     * java.awt.geom.GeneralPath  </td></tr>
     * <tr><td> ij.gui.PolygonRoi </td><td> Roi.FREELINE </td> <td> open
     * java.awt.geom.GeneralPath  </td></tr>
     * <tr><td> ij.gui.PolygonRoi </td><td> Roi.ANGLE </td>    <td> open
     * java.awt.geom.GeneralPath  </td></tr>
     * <tr><td> ij.gui.ShapeRoi </td>  <td> Roi.COMPOSITE </td><td> shape of
     * argument  </td></tr>
     * <tr><td> ij.gui.ShapeRoi </td>  <td> ShapeRoi.NO_TYPE</td><td> null
     * </td></tr>
     * </tbody>
     * </table>
     *
    ...
    /**
     * Constructs a GeneralPath from a float array of segment type+coordinates
     * for each segment. The resulting GeneralPath has winding rule
     * WIND_EVEN_ODD, which is appropriate for closed shapes
     */
     ...
     * PathIterator. Reading starts at 'index'. The position in the array for
     * the next segment is returned, -1 if the array ends. The segment type and
     * coordinates of the segment are stored into 'seg' (which must have a
     ...
     * <br>This method parses the shape into (possibly more than one) Roi
     * objects and returns them in an array.
     * <br>A simple, &quot;regular&quot; path results in a single Roi following
     * these simple rules:
     * <table><col><col><col>
     * <thead><tr><th scope=col> Shape type </th><th scope=col> Roi class
     * </th><th scope=col> Roi type </th></tr></thead>
     * <tbody>
     * <tr><td> java.awt.geom.Rectangle2D.Double </td><td> ij.gui.Roi </td><td>
     * Roi.RECTANGLE </td></tr>
     * <tr><td> java.awt.geom.Ellipse2D.Double </td><td> ij.gui.OvalRoi</td><td>
     * Roi.OVAL </td></tr>
     * <tr><td> java.awt.geom.Line2D.Double </td><td> ij.gui.Line </td><td>
     * Roi.LINE </td></tr>
     * <tr><td> java.awt.Polygon </td>	<td> ij.gui.PolygonRoi </td><td>
     * Roi.POLYGON </td></tr>
     * </tbody>
     * </table>
     * <br><br>Each subpath of a <code>java.awt.geom.GeneralPath</code> is
     * converted following these rules:
     * <table frame="border"><col><col><col><col><col><col>
     * <thead>
     * <tr><th rowspan="2" scope=col> Segment<br> types
     * </th><th rowspan="2" scope=col> Number of<br> segments </th>
     * <th rowspan="2" scope=col> Closed<br> path
     * </th><th rowspan="2" scope=col> Value of<br> forceAngle </th>
     * <th rowspan="2" scope=col> Value of<br> forceTrace
     * </th><th rowspan="2" scope=col> Roi type </th></tr>
     * </thead>
     * <tbody>
     * <tr><td> lines only: </td><td align="center"> 0 </td><td>  </td><td>
     * </td><td>  </td><td> ShapeRoi.NO_TYPE </td></tr>
     * <tr><td>  </td><td align="center"> 1 </td><td>  </td><td>  </td><td>  </td>
     * <td> ShapeRoi.NO_TYPE </td></tr>
     * <tr><td>  </td><td align="center"> 2 </td><td align="center"> Y </td><td>
     * </td><td>  </td><td> ShapeRoi.NO_TYPE </td></tr>
     * <tr><td>  </td><td>  </td><td align="center"> N </td><td>  </td><td>
     * </td><td> Roi.LINE </td></tr>
     * <tr><td>  </td><td align="center"> 3 </td><td align="center"> Y
     * </td><td align="center"> N </td><td>  </td><td> Roi.POLYGON </td></tr>
     * <tr><td>  </td><td>  </td><td align="center"> N </td><td align="center"> Y
     * </td><td>  </td><td> Roi.ANGLE </td></tr>
     * <tr><td>  </td><td>  </td><td align="center"> N </td><td align="center"> N
     * </td><td>  </td><td> Roi.POLYLINE </td></tr>
     * <tr><td>  </td><td align="center"> 4 </td><td align="center"> Y </td><td>
     * </td<td>  </td><td> Roi.RECTANGLE </td></tr>
     * <tr><td>  </td><td>  </td><td align="center"> N </td><td>  </td><td>
     * </td><td> Roi.POLYLINE </td></tr>
     * <tr><td>  </td><td align="center"> &lt;= MAXPOLY </td>	<td align="center">
     * Y </td><td>  </td><td>  </td><td> Roi.POLYGON </td></tr>
     * <tr><td>  </td><td>  </td><td align="center"> N </td><td>  </td><td>
     * </td><td> Roi.POLYLINE </td></tr>
     * <tr><td>  </td><td align="center"> &gt; MAXPOLY </td><td align="center"> Y
     * </td><td>  </td>	<td align="center"> Y </td><td> Roi.TRACED_ROI </td></tr>
     * <tr><td>  </td><td>  </td><td>  </td><td>  </td><td align="center"> N
     * </td><td> Roi.FREEROI </td></tr>
     * <tr><td>  </td><td>  </td><td align="center"> N </td><td>  </td><td>
     * </td><td> Roi.FREELINE </td></tr>
     * <tr><td> anything<br>else: </td><td align="center"> &lt;= 2 </td><td>
     * </td><td>  </td><td>  </td><td> ShapeRoi.NO_TYPE </td></tr>
     * <tr><td>  </td><td align="center"> &gt; 2 </td><td>  </td><td>  </td><td>
     * </td><td> ShapeRoi.SHAPE_ROI </td></tr>
     * </tbody>
     * </table>
     *
     ...
     *
     * @return an ij.gui.Roi object or null if it cannot be simplified to become
     * a non-composite roi.
     */
    ...
    /**
     * Attempts to convert this ShapeRoi into a single non-composite Roi. For
     * showing as a Roi, one should apply copyAttributes
     *
     * @return an ij.gui.Roi object, which is either the non-composite roi, or
     * this ShapeRoi (if such a conversion is not possible) or null if this is
     * an empty roi.
     */
     ...
     *
     * @param nSegments The number of segments that compose the path (= number
     * of vertices for a polygon)
     * @param polygonLength length of polygon in pixels, or NaN if curved
     * segments
     * @param horizontalVerticalIntOnly Indicates whether the GeneralPath is
     * composed of only vertical and horizontal lines with integer coordinates
     * @param forceTrace Indicates that closed shapes with
     * <code>horizontalVerticalIntOnly=true</code> should become TRACED_ROIs
     ...
     */
    /**
     * Checks whether the center of the specified pixel inside of this ROI's
     * shape boundaries. Note the ImageJ convention of 0.5 pixel shift between
     * outline and pixel center, i.e., pixel (0,0) is enclosed by the rectangle
     * spanned between (0,0) and (1,1). The value slightly below 0.5 is for
     * rounding according to the ImageJ convention (which is opposite to that of
     * the java.awt.Shape class): In ImageJ, points exactly at the left (right)
     * border are considered outside (inside); points exactly on horizontal
     * borders, are considered outside (inside) at the border with the lower
     * (higher) y.
     */
    ...
    /**
     * Length of the control polygon of the cubic B&eacute;zier curve argument,
     * in double precision.
     */
    ...
    /**
     * Length of the chord between the end points of the cubic B&eacute;zier
     ...
     * <code>java.awt.geom.CubicCurve2D.Double</code>. Please visit {@link
     * <a href="http://www.graphicsgems.org/gems.html#gemsiv">Graphics Gems
     ...
     * @return an array with the left and right quadratic B&eacute;zier
     * subcurves
     *
     */
     ...
     * @param n number of values in <code>c</code> that should be modified (must
     * be less or equal to the size of <code>c</code>
     *
     */
    ...
    /**
     * Applies an offset xBase, yBase to the n coordinates, which are supposed
     * to be in x, y, x, y ... sequence
     */
     ...
     * from one to seven array elements. The first element of a segment is the
     * type as defined in the PathIterator interface. SEG_MOVETO and SEG_LINETO
     * segments also include two coordinates (one end point), SEG_QUADTO
     * segments include four coordinates and SEG_CUBICTO segments include six
     * coordinates (three points). Coordinates are with respect to the image
     * bounds, not the Roi bounds.
     */
     ...
     * PathIterator; Depending on the <code>task</code> and <code>rois</code>
     * argument it will:
     * <br>- create a single non-Shape Roi and add it to <code>rois</code> in
     * case there is only one subpath, otherwise add this Roi unchanged to
     * <code>rois</code> (task = ONE_ROI and rois non-null)
     * <br>- add each subpath as a Roi to rois; curved subpaths will be
     * flattened, i.e. converted to a polygon approximation (task != ONE_ROI and
     * rois non-null)
     * <br>- measure the combined length of all subpaths/Rois and return it
     * (task = GET_LENGTH, rois may be null)
     *
     * @param pIter the PathIterator to be parsed.
     * @param params an array with one element that will hold the calculated
     * total length of the rois if its initial value is 0. If params holds the
     * value SHAPE_TO_ROI, it will be tried to convert this ShapeRoi to a
     * non-composite Roi. If this is not possible and this ShapeRoi is not
     * empty, a reference to this ShapeRoi will be returned.
     * @param rois an ArrayList that will hold ij.gui.Roi objects constructed
     * from subpaths of this path; may be null only when
     * <code>task = GET_LENGTH</code> (see @link #shapeToRois()} for details;
    ...
    /**
     * Returns this ROI's mask pixels as a ByteProcessor with pixels "in" the
     * mask set to white (255) and pixels "outside" the mask set to black (0).
     * Takes into account the usual ImageJ convention of 0.5 pxl shift between
     * the outline and pixel coordinates; e.g., pixel (0,0) is surrounded by the
     * rectangle spanned between (0,0) and (1,1). Note that apart from the 0.5
     * pixel shift, ImageJ has different convention for the border points than
     * the java.awt.Shape class: In ImageJ, points exactly at the left (right)
     * border are considered outside (inside); points exactly on horizontal
     * borders, are considered outside (inside) at the border with the lower
     * (higher) y.
 ...
 /*BufferedImage bi = new BufferedImage(width, height, BufferedImage.TYPE_BYTE_GRAY);
     ...
     * to the argument.
     * <br>This object will hold a (shallow) copy of the shape argument. If a
     * deep copy of the shape argumnt is required, then a clone of the argument
     * should be passed in; a possible example is
    ...
    /**
     * Returns a FloatPolygon with all vertices of the flattened shape, i.e.,
     * the shape approximated by straight line segments. This method is for
     * listing the coordinates and creating the convex hull.
     *
     * @param flatness Roughly the maximum allowable distance between the shape
     * and the approximate polygon
     * @param separateSubpaths whether individual subpaths should be separated
     * by NaN coordinates
     * @param addPointForClose whether the starting point of a closed subpath
     * should be repeated at its end. Note that with
     * <code>addPointForClose = false</code>, there is no distinction between
    ...
    /**
     * Returns all vertex points of the shape as approximated by polygons, in
    ...
    /**
     * Returns all vertex points of the shape as approximated by polygons, where
     * options may include "close" to add points to close each subpath, and
     ...
     * lines. Note that points might be counted twice where the shape gets
     * closed.
     */
    public int size() {

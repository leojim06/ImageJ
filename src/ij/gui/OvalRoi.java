...
public class OvalRoi extends Roi {
    ...
    /**
     * Feret (caliper width) values, see ij.gui.Roi.getFeretValues(). The
     * superclass method of calculating this via the convex hull is less
     * accurate for the MinFeret because it does not get the exact minor axis.
     */
     ...
     *
     * @param absoluteCoordinates determines whether to use image pixel
     * coordinates instead of coordinates relative to roi origin.
     */
    ...
    /**
     * Returns the number of corner points in the mask of this selection;
     * equivalent to getPolygon().npoints.
     */
    public int size() {
     ...
     * this OvalRoi. Authors: Barry DeZonia and Michael Schmid
     */

...
public class TextRoi extends Roi {
    ...
    /**
     * This method is used by the text tool to add typed characters to displayed
     * text selections.
     */
    ...
    /**
     * Renders the text on the image. Draws the text in the foreground color if
     * ip.setColor(Color) has not been called.
     *
    ...
    public void draw(Graphics g) {
        if (IJ.debugMode) {
            IJ.log("draw: " + theText[0] + "  " + this.width + "," + this.height);
        }
    ...
    /**
     * Returns the name of the default font. Use getCurrentFont().getName() to
     * get the name of the font that this TextRoi is using.
     */
    ...
    /**
     * Returns the default font size. Use getCurrentFont().getSize() to get the
     * size of the font that this TextRoi is using.
     */
    ...
    /**
     * Returns the default font style. Use getCurrentFont().getStyle() to get
     * the style of the font that this TextRoi is using.
     */
    ...
    /**
     * Returns the state of the global 'antialiasedText' variable, which is used
     * by the "Fonts" widget.
     */
    ...
    /**
     * Sets the font face, size, style and antialiasing mode that will be used
     * by TextROIs interactively created using the text tool.
     */

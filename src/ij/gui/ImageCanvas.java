...
public class ImageCanvas extends Canvas implements MouseListener, MouseMotionListener, Cloneable {
    ...
    /**
     * Converts a screen x-coordinate to an offscreen x-coordinate (nearest
     * pixel center).
     */
    ...
    /**
     * Converts a screen y-coordinate to an offscreen y-coordinate (nearest
     * pixel center).
     */
    ...
    /**
     * Converts a screen x-coordinate to an offscreen x-coordinate (Roi
     * coordinate of nearest pixel border).
     */
    ...
    /**
     * Converts a screen y-coordinate to an offscreen y-coordinate (Roi
     * coordinate of nearest pixel border).
     */
     ...
     * Set to 0 to disable long click triggering.
     */

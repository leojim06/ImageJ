...
public class PlotWindow extends ImageWindow implements ActionListener, ItemListener,
    ...
    /**
     * Creates a PlotWindow from a given ImagePlus with a Plot object. (called
     * when reading an ImagePlus with an associated plot from a file)
     */
     ...
     * Note that there are more options available by using the methods of the
     * Plot class instead.
     *
    ...
    /**
     * Sets the Plot object shown in this PlotWindow. Does not update the
     * window.
     */
     ...
     * should lead to resizing the canvas (before, creating the layout can lead
     * to resize events)
     */
    ...
    /**
     * Maximizes the width for the coordinate&status readout field and its
     * parent bottomPanel
     */
    ...
    /**
     * Names for popupMenu items. Update NUM_MENU_ITEMS at the top when adding
     * new ones!
     */
    ...
    /**
     * Creates an overlay with triangular buttons and othr symbols for changing
     * the axis range limits and shows it
     */
     ...
     * 'down' arrow of the lower side of the x axis and end with 7 the up arrow
     * at the upper side of the y axis. Numbers 8 & 9 are for "Reset Range" and
     * "Fit All"; numbers 10-13 for a dialog to set a single limit, and 14-15
     * for the axis options.
     */
    ...
    /**
     * Returns the plot values with simple headings (X, Y, Y1 etc, not the
     * labels) as a ResultsTable. Use plot.getResultsTableWithLabels for a table
     * with data set labels as column headings
     */

...
/**
 * This is a custom layout manager that supports resizing of zoomed images. It's
 * based on FlowLayout, but with vertical and centered flow.
 */
public class ImageLayout implements LayoutManager {
    ...
    /**
     * Determines whether to ignore the width of non-image components when
     * calculating the preferred width (default false, i.e. the maximum of the
     * widths of all components is used). When true, components that do not fit
     * the window will be truncated at the right. The width of the 0th component
     * (the ImageCanvas) is always taken into account.
     */

...
public class Overlay implements Iterable<Roi> {
    ...
    /**
     * Returns the index of the last ROI that contains the point (x,y) or null
     * if no ROI contains the point.
     */
	...
	* Author: Marcel Boeglin
    ...
    /**
     * Removes ROIs having positions outside of the interval defined by
     * firstSlice and lastSlice. Marcel Boeglin, September 2013
     */
 ...
 /* Returns the Roi that results from XORing all the ROIs
     ...
     * 'scale' (enlarge labels when image zoomed), 'bold' (display bold labels)
     * or 'background' (display labels with contrasting background.
     */
    ...
    /**
     * Set 'false' to prevent ROIs in this overlay from being activated by
     * clicking on their labels or by a long clicking.
     */
    ...
    /**
     * Returns 'true' if ROIs in this overlay can be activated by clicking on
     * their labels or by a long press.
     */
    ...
    /**
     * Updates overlays created by the particle analyzer after rows are deleted

...
public class PlotCanvas extends ImageCanvas {
    ...
    /**
     * Tells the PlotCanvas which plot to use for zooming etc. Call this
    ...
    /**
     * Implements the Image/Zoom/Original Scale command. Sets the original range
     * of the x, y axes (unless the plot is frozen)
     */
    public void unzoom() {
        if (plot == null || plot.isFrozen()) {
            super.unzoom();
    ...
    /**
     * Implements the Image/Zoom/View 100% command: Sets the original frame size
     * as specified in Edit/Options/Plots (unless the plot is frozen)
     */
     ...
     * condition while creating a new window, this is ignored if no window
     * exists or the window has not been activated yet.
     */
    ...
    /**
     * The image of a PlotCanvas is always shown at 100% magnification unless
     * the plot is frozen
     */
    ...
    /**
     * Scrolling a PlotCanvas is updating the plot, not viewing part of the
     * plot, unless the plot is frozen
     */
    ...
    /**
     * overrides ImageCanvas.setupScroll; if plot is not frozen, scrolling
     * modifies the plot data range
     */
    ...
    /**
     * overrides ImageCanvas.scroll; if plot is not frozen, scrolling modifies
     * the plot data range
     */
    ...
    /**
     * Returns the index of the arrow for modifying the range when the mouse
     * click was at such an arrow, otherwise -1
     */

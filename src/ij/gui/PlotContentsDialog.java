...
public class PlotContentsDialog implements DialogListener {
     ...
     * thereafter.
     *
     * @param dialogType may be STYLE (contents style), ADD_FROM_PLOT (add
     * object from other plot), ADD_FROM_TABLE, and ADD_FIT
     */
    ...
    /**
     * Prepares a new PlotContentsDialog for creating a new plot using data from
     * a ResultsTable. Use showDialog thereafter.
     */
     ...
     * arrays as data. Each 'data' array in the ArrayList must have a
     * corresponding element in the 'headings' array. 'defaultHeadings' may
     * contain the headings of the items selected initially for x, y, x error
     * and y error, respectively. 'defaultHeadings' and each of its entries may
     * be null, and the array may have any length.
     */
    ...
    /**
     * Prepares a new PlotContentsDialog for adding data from float[] arrays to
     * a plot. Each 'data' array in the ArrayList must have a corresponding
     * element in the 'headings' array. 'defaultHeadings' may contain the
     * headings of the items selected initially for x, y, x error and y error,
     * respectively. 'defaultHeadings' and each of its entries may be null, and
    ...
    /**
     * Returns the style String for Plot.setPlotObjectStyle from the dialog
     * fields
     */
    ...
    /**
     * Sets the style fields of the dialog according to the style of the
     * PlotObject having the index given. Does nothing with index < 0
     */
    ...
    /**
     * Prepare the lists 'allPlots', 'allPlotNames' for the "Add from Plot"
     * dialog. Also sets 'defaultPlotIndex', 'defaultObjectIndex'
     */
    ...
    /**
     * Set up the Choice of Plot objects for the source plot after selecting
     * that plot
     */
    ...
    /**
     * For "Add from Plot", adds item to the plot according to the current
     * Choice settings and sets the Style fields for it.
     */
    ...
    /**
     * Returns whether there is at least one table that can be used for "Add
     * from Table"
     */
    ...
    /**
     * Set up the Choices for the source columns for "Add from Table" and "Add
     * from Arrays"
     */
    ...
    /**
     * For "Add from Table" and "Add from Arrays" adds item to the plot
     * according to the current Choice settings and sets the Style fields for
     * it.
     */
    ...
    /**
     * For "Add from Table" and "Add from Arrays", tries to set a 'y' data
     * column that has not been plotted yet.
     */
    private void suggestNewYColumn() {
        ...
        for (int i = 0; i < nYcolumns; i++) {
            if (columnChoice[0].getSelectedIndex() == 0
                    || //if x is a data column, don't suggest it as y
    ...
    /**
     * Returns whether the table is non-null and has at least one non-trivial
     * data column
     */
    ...
    /**
     * Finds the index of a searchTerm in the String array; returns -1 if not
     * found
     */
    ...
    /**
     * Sets the 'previousColor', 'previousColor2' with a suggestion for new
     * colors
     */

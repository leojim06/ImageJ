...
/**
 * This class represents a collection of points that can be associated with
 * counters. Use the getPolygon() or getFloatPolygon() methods to retrieve the
 * coordinates of the points.
 *
 * @see
 * <a href="http://wsr.imagej.net/macros/js/PointProperties.js">PointProperties.js</a>
 */
public class PointRoi extends PolygonRoi {
     ...
     * converts from a screen coordinate to an image (offscreen) coordinate. The
     * array can be used for adding to an existing point selection
     */
    ...
    /**
     * Returns the points of this Roi that are not contained in the specified
     * area ROI. Returns null if there are no resulting points or Roi is not an
     * area roi.
     */
    ...
    /**
     * Returns the points of this Roi that are contained in the specified area
     * ROI. Returns null if there are no resulting points or Roi is not an area
     * roi.
     */
    ...
    /**
     * Returns an array containing for each point: The counter number (0-100) in
     * the lower 8 bits, and the slice number (or 0, if the point appears on all
     * slices) in the higher 24 bits. Used when writing a Roi to file
     * (RoiEncoder)
     */
    ...
    /**
     * Sets the counter number and slice number for each point from an array,
     * where the lower 8 bits are the counter number and the higher 24 bits
     * contain the slice position of each point. Used when reading a roi
     * fromfile (RoiDecoder).
     */
    ...
    /**
     * Returns the stack slice of the point with the given index, or 0 if no
     * slice defined for this point
     */
    ...
    /**
     * Returns a point index if it has been at least one second since the last
     * point was added and the specified screen coordinates are inside or near a
    ...
    /**
     * Returns the points as an array of Points. Wilhelm Burger: modified to use
     * FloatPolygon for correct point positions.
     */
    ...
    /**
     * Custom iterator for points contained in a {@link PointRoi}. Author: W.
     * Burger
     */

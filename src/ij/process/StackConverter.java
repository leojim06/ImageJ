...
public class StackConverter {
    ...
    /**
     * Converts the stack (which must be RGB) to a 3 channel (red, green and
     * blue) hyperstack.
     */
    ...
    public void convertToHSB(boolean toHSB32) {
        if (type != ImagePlus.COLOR_RGB) {
            throw new IllegalArgumentException("RGB stack required");
        }
        ImageStack stack1 = imp.getStack();
    ...
    /**
     * Converts the stack (which must be RGB) to a 3 channel (hue, saturation
     * and brightness) hyperstack.
     */
    ...
    /**
     * Converts the stack (which must be RGB) to a 3 channel (hue, saturation
     * and brightness) 32-bit hyperstack.
     */
    ...
    /**
     * Converts the stack to 8-bits indexed color. 'nColors' must be greater

...
public class TypeConverter {
    ...
    /**
     * Converts a ColorProcessor to a ByteProcessor. The pixels are converted to
     * grayscale using the formula g=r/3+g/3+b/3. Call
     * ColorProcessor.setRGBWeights() to do weighted conversions.
     */
    ...
    /**
     * Converts a ColorProcessor to a FloatProcessor. The pixels are converted
     * to grayscale using the formula g=r/3+g/3+b/3. Call
     * ColorProcessor.setRGBWeights() to do weighted conversions.
     */
    ...
    /**
     * Converts a ByteProcessor to a FloatProcessor. Applies a calibration
     * function if the 'cTable' is not null.
     *
    ...
    /**
     * Converts a ShortProcessor to a FloatProcessor. Applies a calibration
     * function if the calibration table is not null.
     *
     * @see ImageProcessor.setCalibrationTable
     */

...
public class ColorProcessor extends ImageProcessor {
    ...
    /**
     * Returns an ImageStack with three 32-bit slices, representing hue,
     * saturation and brightness
     */
     ...
     *
     * @param channel Determines the color channel, 1=red, 2=green, 3=blue,
     * 4=alpha
    ...
    /**
     * Sets the current pixels from 3 float arrays (hue, saturation and
     * brightness).
     */
    ...
    /**
     * A 3x3 filter operation, where the argument (ImageProcessor.BLUR_MORE,
     * FIND_EDGES, MEDIAN_FILTER, MIN or MAX) determines the filter type.
     */
    ...
    /**
     * BLUR MORE: 3x3 unweighted smoothing is implemented directly, does not
     * convert the image to three ByteProcessors.
     */

...
public class ShortStatistics extends ImageStatistics {
    ...
    /**
     * Construct an ImageStatistics object from a ShortProcessor using the
     * standard measurement options (area, mean, mode, min and max).
     */
    ...
    /**
     * Constructs a ShortStatistics object from a ShortProcessor using the
     * specified measurement options. The 'cal' argument, which can be null, is
     * currently ignored.
     */

...
/**
 * This is an indexed color model that allows an lower and upper bound to be
 * specified.
 */
public class LUT extends IndexColorModel implements Cloneable {
    ...
    /**
     * Constructs a LUT from red, green and blue byte arrays, which must have a
     * length of 256.
     */
    ...
    /**
     * Constructs a LUT from red, green and blue byte arrays, where 'bits' must
     * be 8 and 'size' must be less than or equal to 256.
     */

...
public class ImageStatistics implements Measurements {
    ...
    /**
     * Calculates and returns uncalibrated (raw) statistics for the specified
     * image, including histogram, area, mean, min and max, standard deviation
     * and mode. Use ImageProcessor.setRoi(x,y,width,height) to limit statistics
     * to a rectangular area and ImageProcessor.setRoi(Roi) to limit to a
    ...
    /**
     * Calculates and returns statistics for the specified image using the
     * specified measurent options and calibration. Use
     * ImageProcessor.setRoi(x,y,width,height) to limit statistics to a
     * rectangular area and ImageProcessor.setRoi(Roi) to limit to a
     * non-rectangular area.
     *
     * @see ij.process.ImageProcessor#setRoi(int,int,int,int)
     * @see ij.process.ImageProcessor#setRoi(Roi)

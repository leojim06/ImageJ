...
public class ImageConverter {
    ...
    /**
     * Converts an RGB image to a 32-bit HSB (hue, saturation and brightness)
     * stack.
     */
    ...
    /**
     * Converts an RGB image to 8-bits indexed color. 'nColors' must be greater
    ...
    /**
     * Set true to scale to 0-255 when converting short to byte or float to byte
     * and to 0-65535 when converting float to short.
     */

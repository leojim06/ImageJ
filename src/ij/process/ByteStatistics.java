...
public class ByteStatistics extends ImageStatistics {
    ...
    /**
     * Construct an ImageStatistics object from a ByteProcessor using the
     * standard measurement options (area, mean, mode, min and max) and no
     * calibration.
     */
    ...
    /**
     * Constructs a ByteStatistics object from a ByteProcessor using the
     * specified measurement and calibration.
     */

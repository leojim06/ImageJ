...
public class ContrastEnhancer implements PlugIn, Measurements {
     ...
     * flat regions of your image. Histogram Equalization can enhance
     * meaningless detail and hide important but small high-contrast features.
     * This method uses a similar algorithm, but uses the square root of the
     * histogram values, so its effects are less extreme. Hold the alt key down
     * to use the standard histogram equalization algorithm. This code was
     * contributed by Richard Kirk (rak@cre.canon.co.uk).
     */

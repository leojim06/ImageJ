...
/**
 * This plugin implements the Image/Stacks/Tools/Make Substack command. What it
 * does is extracts selected images from a stack to make a new substack. It
 * takes three types of inputs: a range of images (e.g. 2-14), a range of images
...
public class SubstackMaker implements PlugIn {
    ...
    /**
     * Extracts selected slices from a stack to make a new substack. Takes three
     * types of inputs: a range of images (e.g. "2-14"), a range of images with
     * an increment (e.g. "2-14-3"), or a list of images (e.g. "7,9,25,27").
     * Precede with 'delete ' (e.g. "delete 2-14") and the slices will be

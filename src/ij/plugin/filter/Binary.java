...
/**
 * Implements the Erode, Dilate, Open, Close, Outline, Skeletonize and Fill
 * Holes commands in the Process/Binary submenu. Gabriel Landini contributed the
 * clever binary fill algorithm that fills holes in objects by filling the
 * background. Version 2009-06-23 preview added, interations can be aborted by
 * escape (Michael Schmid)
 */

 ...
 * <
 * pre>
 * for each line do for each pixel in this line do if the pixel value is
 * "inside" the threshold range then trace the edge to mark the object do the
 * measurement fill the object with a color outside the threshold range else
 * continue the scan
 * </pre>
 */
public class ParticleAnalyzer implements PlugInFilter, Measurements {
     ...
     * @param maxCirc	maximum circularity      <pre>
     * // JavaScript example

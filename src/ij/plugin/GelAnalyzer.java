...
/**
 * This plugin generates gel profile plots that can be analyzed using the wand
 * tool. It is similar to the "Gel Plotting Macros" in NIH Image.
 */

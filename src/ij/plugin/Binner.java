...
/**
 * This plugin implements the Image/Transform/Bin command. It reduces the size
 * of an image or stack by binning groups of pixels of user-specified sizes. The
 * resulting pixel can be calculated as average, median, maximum or minimum.
 *

...
public class DICOM extends ImagePlus implements PlugIn {
    ...
    /**
     * Opens the specified file as a DICOM. Does not display a message if there
    ...
    public DicomDecoder(String directory, String fileName) {
        ...
        if (dictionary == null && IJ.getApplet() == null) {
            ...
            if (f.exists()) try {
                ...
                is.close();
                if (IJ.debugMode) {
                    IJ.log("DicomDecoder: using " + dictionary.size() + " tag dictionary at " + path);
                }
            } catch (Exception e) {
                dictionary = null;
            }
        ...
        if (dictionary == null) {
            ...
            if (IJ.debugMode) {
                IJ.log("DicomDecoder: " + path + " not found; using " + dictionary.size() + " tag built in dictionary");
            }
        }
    }

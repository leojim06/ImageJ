...
/**
 * This plugin implements the File/Import/XY Coordinates command. It reads a two
 * column text file, such as those created by File/Save As/XY Coordinates, as a
 * polygon ROI. The ROI is displayed in the current image or, if the image is
 * too small, in a new blank image.
 */

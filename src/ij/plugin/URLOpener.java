 ...
 * file names must end in ".dcm". Opens a Web page in the default browser if the
 * URL ends with "/".
 */
public class URLOpener implements PlugIn {
    ...
    /**
     * If 'urlOrName' is a URL, opens the image at that URL. If it is a file
     * name, opens the image with that name from the 'images.location' URL in

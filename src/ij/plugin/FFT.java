 ...
 * commands in the Process/FFT submenu. It is based on Arlo Reeves' Pascal
 * implementation of the Fast Hartley Transform from NIH Image
...
public class FFT implements PlugIn, Measurements {
    ...
    /**
     * Complex to Complex Inverse Fourier Transform Author: Joachim Wesner
     */
    ...
    /**
     * Build FHT input for equivalent inverse FFT Author: Joachim Wesner
     */

...
public class HyperStackConverter implements PlugIn {
    ...
    /**
     * Converts the specified stack into a hyperstack with 'c' channels, 'z'
     * slices and 't' frames using the default ordering ("xyczt") and display
     * mode ("Composite").
     */
    ...
    /**
     * Converts the specified stack into a hyperstack with 'c' channels, 'z'
     * slices and 't' frames using the default ordering ("xyczt") and the
     * specified display mode ("composite", "color" or "grayscale").
     */
    ...
    /**
     * Converts the specified stack into a hyperstack with 'c' channels, 'z'
     * slices and 't' frames. The default "xyczt" order is used if 'order' is
     * null. The default "composite" display mode is used if 'mode' is null.
     *
     * @param imp the stack to be converted
     * @param c channels
     * @param z slices
     * @param t frames
     * @param order hyperstack order ("default", "xyctz", "xyzct", "xyztc",
     * "xytcz" or "xytzc")
    ...
    /**
     * Changes the dimension order of a 4D or 5D stack from the specified order
     * (CTZ, ZCT, ZTC, TCZ or TZC) to the XYCZT order used by ImageJ.
     */

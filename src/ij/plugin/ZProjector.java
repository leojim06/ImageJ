...
public class ZProjector implements PlugIn {
     ...
     * returns the result, where 'method' is "avg", "min", "max", "sum", "sd" or
     * "median". Add " all" to 'method' to project all hyperstack time points.
     */
    ...
    //Added by Marcel Boeglin 2013.09.23
    /**
     * Performs actual projection using specified method. If handleOverlay, adds
     * stack overlay elements from startSlice to stopSlice to projection.
     */
    ...
    class AverageIntensity extends RayFunction {
        ...
        /**
         * Constructor requires number of slices to be projected. This is used
         * to determine average at each pixel.
         */

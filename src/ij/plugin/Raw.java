...
public class Raw implements PlugIn {
    ...
    /**
     * Opens all the images in the specified directory as a stack, using the
     * format specified by 'fi'.
     */
    ...
    /**
     * Opens all the images in the specified directory as a virtual stack, using
     * the format specified by 'fi'.
     */

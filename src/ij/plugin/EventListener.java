...
/**
 * This plugin implements the Plugins/Utilities/Monitor Events command. By
 * implementing the IJEventListener, CommandListener, ImageListener and
 * RoiListener interfaces, it is able to monitor foreground and background color
 * changes, tool switches, Log window closings, command executions, image window
 * openings, closings and updates, and ROI changes.
 */

 ...
 * dialog and opens and displays the selected file. If 'arg' is a path, it opens
 * the specified file and the calling routine can display it using
...
class BMPDecoder {
    ...
    void getBitmapHeader() throws IOException {
        ...
        } else // a value of 0 means we determine this based on the bits per pixel
        if (bitsPerPixel < 16) {

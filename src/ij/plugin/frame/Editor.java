...
public class Editor extends PlugInFrame implements ActionListener, ItemListener,
    ...
    /**
     * ImportPackage statements added in front of scripts. Contains no newlines
     * so that lines numbers in error messages are not changed.
     */
    ...
    /**
     * Opens an example from the Help/Examples menu and runs if "Autorun
     * Exampes" is checked.
     */
    ...
    /**
     * Override windowActivated in PlugInFrame to prevent Mac menu bar from
     * being installed.
     */

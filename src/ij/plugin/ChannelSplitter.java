...
public class ChannelSplitter implements PlugIn {
    ...
    /**
     * Returns, as an ImageStack, the specified channel, where 'c' must be
     * greater than zero and less than or equal to the number of channels in the
     * image.
     */
    ...
    /**
     * Splits the specified RGB stack into three 8-bit grayscale stacks. Deletes
     * the source stack if keepSource is false.
     */

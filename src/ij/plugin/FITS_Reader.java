...
/**
 * Opens and displays FITS images. The FITS format is described at
 * "http://fits.gsfc.nasa.gov/fits_standard.html". Add
 * setOption("FlipFitsImages",false) to the Edit/Options/Startup dialog to have
 * FITS images not flipped vertically.
 */

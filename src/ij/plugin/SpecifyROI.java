 ...
 *
 * New update, correctly handling existing oval ROIs, the case that "Centered"
 * is already selected when the plugin starts, and always restoring the original
 * ROI when the dialog is cancelled (JW, 2008/02/22)
 *
 * Enhancing the original plugin created by Jeffrey Kuhn, this one takes, in

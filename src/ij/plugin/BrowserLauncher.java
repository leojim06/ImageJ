 ...
 * (Windows, Mac OS X and Unix) BrowserLauncher class.
 * <p>
...
public class BrowserLauncher implements PlugIn {
    ...
    /**
     * Opens the specified URL in the default browser. Returns a message if
     * there is an error. Call from a macro using:<br>

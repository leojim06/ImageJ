...
/**
 * The plugin implements the Image/Stacks/Tools/Montage to Stack command. It
 * creates a w*h image stack from an wxh image montage. This is the opposite of
 * what the "Make Montage" command does. 2010.04.20,TF: Final stack can be
 * cropped to remove border around frames.
 */

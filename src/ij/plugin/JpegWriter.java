...
/**
 * The File/Save As/Jpeg command (FileSaver.saveAsJpeg() method) uses this
 * plugin to save images in JPEG format.
 */
public class JpegWriter implements PlugIn {
    ...
    /**
     * Enhance quality of JPEGs by disabing chroma subsampling. By default,
     * enhanced quality is automatically used when the Quality setting is 90 or
     * greater.
     */

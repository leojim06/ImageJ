...
/**
 * The plugin implements the Image/Adjust/Coordinates command. It allows the
 * user to set the corner coordinates of the selection bounds or the full image.
 * This modifies the image scale (pixelWidth, pixelHeight) and the xOrigin,
 * yOrigin. If a single point is selected, the coordinates of the point can be
 * specified, which only sets the xOrigin and yOrigin. Units for x and y can be
 * also selected (2016-08-30, Michael Schmid). Z unit of stacks can be selected
 * (2019-09-30, Stein Rorvik).
 */

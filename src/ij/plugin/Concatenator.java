...
public class Concatenator implements PlugIn, ItemListener {
    ...
    /**
     * Optional string argument sets the name dialog boxes if called from
     * another plugin.
     */
    ...
    /**
     * Displays a dialog requiring user to choose images and returns ImagePlus
     * of concatenated images.
     */
    ...
    /**
     * Obsolete, replaced by concatenate(images,keep) and
     * Concatenator.run(images).
     */

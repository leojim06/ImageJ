...
public class ImageStack {
     ...
     * newline), with the extension removed, of the specified slice label, or
    ...
    /**
     * Returns a shortened version (up to the first 'max' characters or first
     * newline), with the extension removed, of the specified slice label, or
     * null if the slice does not have a label.
     */
     ...
     * IndexOutOfBoundsException if x, y or z are beyond the stack limits. Use
     * the ImagePlus.getStackIndex() method to convert a C,Z,T hyperstack
     * position (one-based) into a z index (zero-based).
     *

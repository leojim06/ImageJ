...
public class DicomTools {
    ...
    /**
     * Calculates the voxel depth of the specified DICOM stack based on the
     * distance between the first and last slices.
     */
    ...
    /**
     * Returns the value (as a string) of the specified DICOM tag id (in the
     * form "0018,0050") of the specified image or stack slice. Returns null if
     * the tag id is not found.
     */

...
/**
 * This class allows for simple wildcard pattern matching. Possible patterns
...
public class WildcardMatch {
    ...
    /**
     * Sets new characters to be used as wildcard characters, overriding the the
     * default of '?' for any single character match and '*' for any amount of
     * characters, including 0 characters.
     *
    ...
    /**
     * Matches a string against a pattern with wildcards. Two wildcard types are
     * supported: single character match (defaults to '?') and ANY character
     * match ('*'), matching any count of characters including 0. Wildcard
     * characters may be escaped by an escape character, which defaults to '\'.
     *

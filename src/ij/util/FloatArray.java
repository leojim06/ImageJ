...
/**
 * This class implements an expandable float array similar to an ArrayList or
 * Vector but more efficient. Calls to this class are not synchronized.
 *
...
public class FloatArray {
    ...
    /**
     * Appends the specified value to the end of this FloatArray. Returns the
     * number of elements after adding.
     */
    ...
    /**
     * Deletes the last <code>n</code> element from this FloatArray.
     * <code>n</code> may be larger than the number of elements; in that case,

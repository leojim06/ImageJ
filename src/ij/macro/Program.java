...
public class Program implements MacroConstants {
    ...
    public Program() {
        ...
        if (IJ.debugMode) {
            IJ.log("Symbol table: " + (stLoc + 1) + "  " + table.length + "  " + systemTable.length);
        }
    }
    ...
    void enlargeSymbolTable() {
        ...
        maxSymbols *= 2;
        if (IJ.debugMode) {
            IJ.log("enlargeSymbolTable: " + table.length);
        }
    }
    ...
    /**
     * Looks up a word in the symbol table. Returns null if the word is not
     * found.
     */

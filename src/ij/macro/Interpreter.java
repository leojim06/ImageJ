...
public class Interpreter implements MacroConstants {
    ...
    /**
     * Runs an existing macro starting at the specified program counter
     * location.
     */
    ...
    /**
     * Searches the entire stack for the specified variable. Returns null if it
     * is not found.
     */
    ...
    /**
     * The specified string, if not null, is added to strings passed to the
     * run() method.
     */

...
public class Calibration implements Cloneable {
     ...
     * This string is saved in the TIFF header if it is not longer than 64
     * characters and it contains no '=' or '\n' characters.
     */
    public String info;
    ...
    /**
     * Returns the plural form of the unit passed as argument (e.g. "micron"
     * gives "microns", "inch" gives "inches").
     */
    ...
    /**
     * Returns the plural form of the X length unit (e.g. "microns", "inches"),
     * or of the default unit if 'xunit' is null.
     */
    ...
    /**
     * Returns the plural form of the Y length unit (e.g. "microns", "inches"),
     * or of the default unit if 'yunit' is null.
     */
    ...
    /**
     * Returns the plural form of the Z length unit (e.g. "microns", "inches"),
     * or of the default unit if 'zunit' is null.
     */
    ...
    /**
     * Converts a y-coordinate in pixels to physical units (e.g. mm), taking
     * into account the invertY and global "Invert Y Coordinates" flags.
     */
    ...
    /**
     * Converts a y-coodinate in physical units to pixels, taking into account
     * the 'invertY' flag.
     */
    ...
    /**
     * Disables the density calibation if the specified image has a differenent
     * bit depth.
     */
    ...
    /**
     * Returns the calibration table. With 8-bit images, the table has a length
     * of 256. With 16-bit images, the length is 65536.
     */
    ...
    /**
     * Sets the calibration table. With 8-bit images, the table must have a
     * length of 256. With 16-bit images, it must be 65536.
     */

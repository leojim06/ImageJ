...
/**
 * Plugins that implement this interface are notified when the user changes the
 * foreground color, changes the background color, closes the color picker,
 * closes the Log window or switches to another tool.
 */

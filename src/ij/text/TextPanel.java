...
public class TextPanel extends Panel implements AdjustmentListener,
    ...
    /**
     * Copies the current selection to the system clipboard. Returns the number
    ...
    /**
     * Replaces the contents of the specified line, where 'index' must be
    ...
    /**
     * Returns the index of the last selected line, or -1 if there is no
     * slection.
     */
